...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		RobotMap.Init();
		driver = new Driver(RobotMap.leftFrontMotor,RobotMap. leftBackMotor,RobotMap. rightFrontMotor,RobotMap. rightBackMotor);
		m_oi = new OI();
		// chooser.addObject("My Auto", new MyAutoCommand());
		SmartDashBoardInit();
		SmartDashboard.putData("G", m_chooser);
	}
	...
	public void SmartDashBoardInit() {
		SmartDashboard.putNumber("Motor", 6);
	}
